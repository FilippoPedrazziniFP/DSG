...
def main():
	...
	# Clean Trade Data
	trade_preprocessor = BaselinePreprocessor(
		from_date=20180101,
		train_samples=args.train_samples,
		test_samples=args.test_samples,
		val_samples=args.val_samples
		)
	X_train, y_train, X_test, y_test, X_val, y_val, X, y = trade_preprocessor.fit_transform(df)
	...
	# Fit on the entire data and create the submission file
	# model.fit(X, y)
